...
// One ping per page load, shared across StrictMode remounts. The Render free
// tier spins the backend down after ~15 min idle; this fire-and-forget request
// starts the cold boot as soon as the page loads, before the user hits Analyze.
